import IconWaves from "@/_components/icons/IconWaves";
...
import { ArrowRight, Calendar, Heart, Info, MapPin, Phone } from "lucide-react";
...
export async function generateMetadata({ params }: AnimalIdPageProps) {
        ...
        <Card>
          <CardContent className="flex flex-col">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-2/3 p-6 lg:p-8 lg:pb-0">
            ...
            <div className=" pt-4 border-t border-gray-100 gap-8 grid grid-cols-12">
              ...
              <div className="pt-4 flex-grow col-span-8 ">
                ...
                <div className="prose prose-sm max-w-none">
                  {animal.description ? (
                    <p className="leading-relaxed text-justify">{animal.description}</p>
                  ) : (
              ...
              {/* Boutons d'action */}
              <div className="gap-4 col-span-4 flex flex-col justify-center items-center border-l border-gray-100 h-full">
